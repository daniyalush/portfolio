        ...
        <section className='grid md:grid-cols-2 my-12 md:my-12 py-12 gap-4 relative'>
            ...
            <div className="z-10">
                ...
                <p className='text-black font-medium mb-4 max-w-md'>
                    {" "}
                    Welcome to my world! I'm thrilled you stopped by.
                    If you have any questions, want to discuss a project, or just share your thoughts, I'd love to hear from you.
                    Simply use the friendly chat feature on my portfolio website, and let's start a conversation.
                    Your messages brighten my day, and I can't wait to connect with you and explore the possibilities together!
                </p>
            ...
            <div>
                <form className='flex flex-col'>
                    ...
                    <button
                        type="submit" className="border border-black bg-purple-500 hover:bg-purple-600 text-black font-medium py-2.5 px-5 rounded-lg w-full">
                        Send Message
                    </button>
                </form>
            </div>
